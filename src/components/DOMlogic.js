...
// Create an H Element
const addHElement = (typeOfElement, parentDivId, divId, desiredText) => {
  let hElement = document.createElement(typeOfElement);
  let parentDiv = document.getElementById(parentDivId);
  hElement.setAttribute("id", divId);
  hElement.textContent = desiredText;
  parentDiv.appendChild(hElement);
};
...
export { createNewDiv, setClassAttr, createImg, addText, addHElement, addBtn };
